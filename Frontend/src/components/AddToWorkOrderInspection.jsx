...
const AddToWorkOrderInspection = () => {
  ...
  useEffect(() => {
    const fetchRepairById = async () => {
      ...
      try {
        const response = await api.get(`/inspection/${id}`); // ✅ Fixed URL syntax
  ...
  const handleSubmit = () => {
    ...
    const newWorkOrder = {
      ...
      repair_category: repair?.phone_number,
        ...
        <main className="grow bg-white dark:bg-gray-800 w-[95%] mt-10 m-auto rounded-md">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <h2 className="uppercase tracking-wider text-blue-700 phone:text-md tablet:text-xl font-bold text-left mb-6">
              Add to Work Order From Inspection
            </h2>
            <div className="border rounded-md border-blue-500 py-6 px-6 overflow-hidden">
              ...
              <div className="grid phone:grid-cols-1 tablet:grid-cols-2 gap-4">
                ...
                {/* Repair Category */}
                <div className="mb-4">
                  <label className="block dark:text-gray-200 dark:text-white text-sm font-medium text-gray-700">
                    phone
                  </label>
                  <input
                    type="text"
...
export default AddToWorkOrderInspection;

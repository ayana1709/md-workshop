      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 space-y-6">
          ...
          {withReceipt && (
            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg border p-4 shadow-md">
              ...
              <input
                ...
                onChange={(e) =>
                  setPayment({ ...payment, invoiceNumber: e.target.value })
                }
              />
          ...
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg border p-4 shadow-md">
            <h3 className="font-bold text-lg mb-3 text-purple-700">Payment</h3>
                ...
                <select
                  ...
                  onChange={(e) => {
                    if (e.target.value === "other") {
                      ...
                      setPayment({ ...payment, transferInfo: e.target.value });
                    }
                  }}
                >

...
const Incoming = () => {
  ...
  const tabs = ["total-incoming", "recently-incoming", "pending"];
  ...
  useEffect(() => {
    const fetchItemCount = async () => {
      try {
        const response = await api.get("/Incoming-items/count");
    ...
    <div className="w-full flex h-screen overflow-y-auto bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="relative phone:w-[98%] tablet:w-[90%] laptop:w-[98%] mx-auto my-6 mt-4 shadow-md rounded-lg overflow-y-auto">
          ...
          {/* Active Content */}
          <div className="relative z-[9] phone:w-full mx-auto transition-all duration-500 phone:px-[4px] tablet:px-4 pb-4 bg-gray-200 dark:bg-gray-700 text-black rounded-b-lg shadow-md mb-24">
            <div className="pt-6">
              <Outlet />
            </div>
          </div>

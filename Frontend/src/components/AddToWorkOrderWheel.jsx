...
const AddToWorkOrderWheel = () => {
  ...
  useEffect(() => {
    const fetchRepairById = async () => {
      ...
      try {
        const response = await api.get(`/view-wheel/${id}`); // ✅ Fixed URL syntax
  ...
  const handleSubmit = () => {
    ...
    const newWorkOrder = {
      job_card_no: id,
      plate_number: repair?.tin_number,
      customer_name: repair?.customer_name,
      repair_category: repair?.mobile,
        ...
        <main className="grow bg-white dark:bg-gray-800 w-[95%] mt-10 m-auto rounded-md">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <h2 className="uppercase tracking-wider text-blue-700 phone:text-md tablet:text-xl font-bold text-left mb-6">
              Add to Work Order From Wheel Alignment
            </h2>
            <div className="border rounded-md border-blue-500 py-6 px-6 overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="table-fixed min-w-full table-auto w-full border-collapse border border-green-300 overflow-x-auto">
                  <thead className="bg-green-500 text-white text-left text-sm">
                    <tr className="">
                      ...
                      >
                        ...
                        <td className="border p-2 w-1/4">
                          <input
                            ...
                            value={row.totalcost}
                            disabled
                            className="w-full dark:bg-gray-800 dark:text-white placeholder:dark:text-white border rounded px-2 py-1 bg-gray-200 border-gray-300"
                          />
                        </td>
                        {/* Assign To */}
                        <td className="border border-green-300 p-2 w-1/2">
                          <select
                            ...
                            className="text-xs dark:bg-gray-800 dark:text-white placeholder:dark:text-white w-full border rounded px-2 py-1 border-gray-300"
                          >
...
export default AddToWorkOrderWheel;

...
const InspectionList = () => {
  ...
  const handleFilter = () => {
    let filteredRepairs = inspection;
  ...
  const handleNavigation = (option, id) => {
    const routes = {
      View: `/view-inspection/${id}`,
      Edit: `/edit-inspection/${id}`,
      Delete: `/delete/${id}`,
      "Add to Work": `/add-t-work-order-inspection/${id}`,
      "Request Spare": `/request-spare-inspection/${id}`,
    };
  ...
  const deleteSelectedRows = async () => {
    ...
    try {
      const response = await api.delete("/inspections", {
        ...
        <table className="table-fixed min-w-full table-auto w-full border-collapse border border-table-border overflow-x-auto">
          <thead className="bg-table-head text-white text-left text-sm">
            <tr>
              ...
              <th className="border border-table-border p-2 w-[100px]">Make</th>
                      ...
                      <div className="absolute pt-10 z-1 right-2 top-[55%] -translate-y-1/2 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-md z-10">
                        ...
                        {[
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (option === "Delete") {
                                handleDeleteClick(repair.id, "inspection");
                              } else {

...
function FormalProformaTable({
  ...
  // Row controls
  // const addLabourRow = () => setLabourRows([...labourRows, {}]);
  const addSpareRow = () =>
    setSpareRows([
      ...spareRows,
      {
          ...
          <table className="w-full border-collapse text-xs sm:text-sm md:text-base">
            <thead>
              <tr>
                ...
                <th className={`${tableHeaderStyle} min-w-[60px]`}>Unit</th>
                {/* <th className={`${tableHeaderStyle} min-w-[140px]`}>Brand</th> */}
                <th className={`${tableHeaderStyle} min-w-[80px]`}>Qty</th>
                <th className={`${tableHeaderStyle} min-w-[110px]`}>
                  Unit Price
                </th>
                <th className={`${tableHeaderStyle} min-w-[80px]`}>Total</th>
                <th className={`${tableHeaderStyle} min-w-[80px]`}>Remark</th>
       ...
       ================================ */
                  ...
                  <td className={cell}>
                    <input
                      ...
                      className={`${input} w-full sm:w-auto min-w-[80px]`}
                      placeholder=" "
                    />
                  </td>
...
export default FormalProformaTable;

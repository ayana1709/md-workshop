    ...
    <div className="min-w-0">
      ...
      >
        ...
        <div className="space-y-0">
          <div>
            <h3
              className={`text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3 transition-all duration-300 overflow-hidden whitespace-nowrap`}
            >
            ...
            <ul className="mt-3 space-y-1">
              {/* Dashboard */}
              {/* Helper: same label class everywhere (optional) */}
              {/* const label = `ml-4 text-sm font-medium whitespace-nowrap transition-opacity duration-200 ${sidebarExpanded ? "opacity-100" : "opacity-0"}`; */}
                      ...
                      <svg
                        className={`shrink-0 ${
                          pathname.includes("dashboard")
                            ...
                            : "text-gray-400 dark:text-gray-500 fill-green-500"
                        }`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
              ...
              {/* Proforma */}
              <SidebarLinkGroup activecondition={pathname.includes("proforma")}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <a
                      href="#0"
              ...
              {/* Weekly Checklist */}
              <SidebarLinkGroup
                activecondition={pathname.includes("weekly-checklist")}
              >
                {(handleClick, open) => (
                  <React.Fragment>
                    <a
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <svg
                            className={`shrink-0 fill-green-500 ${
                              pathname.includes("weekly-checklist")
                                ? "text-violet-500"
                                : "text-gray-400 dark:text-gray-500"
                            }`}
                            xmlns="http://www.w3.org/2000/svg"
